...
public class JobInfoController {
    ...
    public static List<XxlJobGroup> filterJobGroupByRole(HttpServletRequest request, List<XxlJobGroup> allJobGroupList) {
        List<XxlJobGroup> jobGroupList = new ArrayList<>();
        if (allJobGroupList != null && allJobGroupList.size() > 0) {
